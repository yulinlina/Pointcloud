...
from fit import *
from show import *
# from planeFit import planeClass
...
def fetchPoints(inputTypeIndex=1,normalizeFlag=True):
    ...
    if inputType=='depthPic':
        ...
        x2,y2,z2=randomChoice(x1,y1,z1,100)
        ...
        xmin, ymin, xmax, ymax = [-0.5, -0.3, -0.178, 0.1]
        x2, y2, z2 = makePoint(xmin,ymin,xmax,ymax,a=1,b=0,d=0.0,pointsNum=100)
...
x2,y2,z2=fetchPoints(inputTypeIndex=1)
pointsNum=len(z2)
...
# x2,y2,z2=fetchPoints(inputTypeIndex=1)
# t1=time.time()
# adata,bdata,cdata,ddata=pc.run(x2,y2,z2)
# print(time.time()-t1)
